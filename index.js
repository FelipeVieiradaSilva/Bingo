const NUM_ROWS = 5;
      ...
      function drawNumber() {
        ...
        document.getElementById("drawn-numbers").textContent = `Números Sorteados: ${drawnNumbers.join(", ")}`;
      }

      function checkWin(cells, board) {
        ...
        const playerName = board.getElementsByTagName("h2")[0].textContent.split(" - ")[0];
        const cardNumber = parseInt(
          board.getElementsByTagName("h2")[0].textContent.split(" - ")[1].replace("Cartela ", "")
        );
